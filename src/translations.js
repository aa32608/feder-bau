...
export const products = [
  ...
  },
  {
    name: 'Memory Foam',
    slug: 'memory-foam',
    image: 'assets/products/memory-foam.jpg',
    height: '22 cm',
    categoryKey: 'memory',
    price: null,
    detail: {
      en: '22 cm memory mattress with polyester microfiber fabric, organic cotton, Polio Soft foam, Myform Memori foam, and Jakarta fabric.',
      sq: 'Dyshek memory 22 cm me pëlhurë mikrofibër poliestër, pambuk organik, shkumë Polio Soft, Myform Memori foam dhe pëlhurë Jakarta.',
      mk: 'Memory душек од 22 cm со полиестерска микрофибер ткаенина, органски памук, Polio Soft пена, Myform Memori пена и Jakarta ткаенина.',
    },
    description: {
      en: 'Memory Foam is a 22 cm Feder Bau mattress built around the layers shown in its product photo: polyester microfiber fabric, highly breathable fabric, organic cotton, Polio Soft foam, High Resilience foam, Myform Memori foam, Polio flexible hard foam, and Jakarta fabric. The construction balances adaptive memory comfort with stable support and a breathable, premium-feeling sleep surface.',
      sq: 'Memory Foam është dyshek 22 cm Feder Bau i ndërtuar sipas shtresave të paraqitura në foton e produktit: pëlhurë mikrofibër poliestër, pëlhurë shumë e ajrosshme, pambuk organik, shkumë Polio Soft, shkumë me reziliencë të lartë, Myform Memori foam, shkumë fleksibile e fortë Polio dhe pëlhurë Jakarta. Konstruksioni balancon komfortin adaptiv memory me mbështetje stabile dhe sipërfaqe gjumi të ajrosshme me ndjesi premium.',
      mk: 'Memory Foam е душек од 22 cm на Feder Bau изграден според слоевите прикажани на продуктовата фотографија: полиестерска микрофибер ткаенина, високо дишлива ткаенина, органски памук, Polio Soft пена, високоеластична пена, Myform Memori пена, Polio флексибилна тврда пена и Jakarta ткаенина. Конструкцијата балансира адаптивна memory удобност со стабилна поддршка и дишлива површина за спиење со премиум чувство.',
    },
    materials: [
...

  {
    name: 'Majestic',
    slug: 'majestic',
    image: 'assets/products/majestic.jpg',
    height: '28 cm',
    categoryKey: 'spring',
    price: null,
    detail: {
      en: '28 cm premium spring mattress with Cashmere microfiber fabric, Bonell Hercul Spring support, hard-felt reinforcement, and Myform Memori foam.',
      sq: 'Dyshek premium me susta 28 cm me pëlhurë mikrofibër cashmere, mbështetje Bonell Hercul Spring, përforcim me felt të fortë dhe Myform Memori foam.',
      mk: 'Премиум пружински душек од 28 cm со cashmere микрофибер ткаенина, Bonell Hercul Spring поддршка, засилување со тврд филц и Myform Memori пена.',
    },
    description: {
      en: 'Majestic is a 28 cm Feder Bau spring mattress built from the materials listed in its product photo: cashmere and polyester microfiber fabric, highly breathable fabric, organic cotton, Myform Memori foam, High Resilience foam, twin layers hard felt, Bonell Hercul Spring, multi inner filling foam, and a hard felt layer. The result is a premium spring construction that pairs adaptive surface comfort with firm, durable support.',
      sq: 'Majestic është dyshek me susta 28 cm nga Feder Bau, i ndërtuar me materialet e listuara në foton e produktit: pëlhurë mikrofibër cashmere dhe poliestër, pëlhurë shumë e ajrosshme, pambuk organik, Myform Memori foam, shkumë me reziliencë të lartë, dy shtresa felt i fortë, Bonell Hercul Spring, shkumë mbushëse e brendshme dhe shtresë felt i fortë. Rezultati është konstruksion premium me susta që bashkon komfort adaptiv në sipërfaqe me mbështetje të fortë dhe të qëndrueshme.',
      mk: 'Majestic е пружински душек од 28 cm на Feder Bau, изграден од материјалите наведени на продуктовата фотографија: cashmere и полиестерска микрофибер ткаенина, високо дишлива ткаенина, органски памук, Myform Memori пена, високоеластична пена, двојни слоеви тврд филц, Bonell Hercul Spring, внатрешна полначка пена и слој тврд филц. Резултатот е премиум пружинска конструкција што комбинира адаптивна површинска удобност со цврста и издржлива поддршка.',
    },
    materials: [
      { en: 'Cashmere and polyester microfiber fabric', sq: 'Pëlhurë mikrofibër cashmere dhe poliestër', mk: 'Cashmere и полиестерска микрофибер ткаенина' },
      { en: 'Organic cotton', sq: 'Pambuk organik', mk: 'Органски памук' },
      ...
      { en: 'High Resilience foam', sq: 'Shkumë me reziliencë të lartë', mk: 'Високоеластична пена' },
      { en: 'Twin layers hard felt', sq: 'Dy shtresa felt i fortë', mk: 'Двојни слоеви тврд филц' },
      { en: 'Bonell Hercul Spring', sq: 'Susta Bonell Hercul', mk: 'Bonell Hercul Spring' },
      { en: 'Multi inner filling foam', sq: 'Shkumë mbushëse e brendshme', mk: 'Внатрешна полначка пена' },
...

  {
    name: 'Dreamer Gold',
    slug: 'dreamer-gold',
    image: 'assets/products/dreamer-gold.jpg',
    height: '38 cm',
    categoryKey: 'premium',
    price: null,
    detail: {
      en: '38 cm luxury mattress with Tencel microfiber fabric, Polio Soft comfort, Dual Technology Pocket Spring support, and Myform Memori foam.',
      sq: 'Dyshek luksoz 38 cm me pëlhurë mikrofibër Tencel, komfort Polio Soft, mbështetje Dual Technology Pocket Spring dhe Myform Memori foam.',
      mk: 'Луксузен душек од 38 cm со Tencel микрофибер ткаенина, Polio Soft удобност, Dual Technology Pocket Spring поддршка и Myform Memori пена.',
    },
    description: {
      en: 'Dreamer Gold is the 38 cm premium Feder Bau mattress shown in the product photo. Its construction lists Tencel and polyester microfiber fabric, highly breathable fabric, organic cotton, Polio Soft foam, Polio flexible hard foam, Dual Technology Pocket Spring, high resilience foam, and Myform Memori foam. This tall build combines plush comfort layers with pocket-spring support for a luxurious, adaptive sleep feel.',
      sq: 'Dreamer Gold është dysheku premium 38 cm i Feder Bau i paraqitur në foton e produktit. Konstruksioni i tij përfshin pëlhurë mikrofibër Tencel dhe poliestër, pëlhurë shumë të ajrosshme, pambuk organik, shkumë Polio Soft, shkumë fleksibile të fortë Polio, Dual Technology Pocket Spring, shkumë me reziliencë të lartë dhe Myform Memori foam. Ky ndërtim i lartë kombinon shtresa të buta komforti me mbështetje pocket-spring për ndjesi gjumi luksoze dhe adaptive.',
      mk: 'Dreamer Gold е премиум душекот од 38 cm на Feder Bau прикажан на продуктовата фотографија. Неговата конструкција вклучува Tencel и полиестерска микрофибер ткаенина, високо дишлива ткаенина, органски памук, Polio Soft пена, Polio флексибилна тврда пена, Dual Technology Pocket Spring, високоеластична пена и Myform Memori пена. Оваа висока конструкција комбинира меки комфорни слоеви со pocket-spring поддршка за луксузно и адаптивно чувство при спиење.',
    },
    materials: [
      { en: 'Tencel and polyester microfiber fabric', sq: 'Pëlhurë mikrofibër Tencel dhe poliestër', mk: 'Tencel и полиестерска микрофибер ткаенина' },
      { en: 'Organic cotton', sq: 'Pambuk organik', mk: 'Органски памук' },
